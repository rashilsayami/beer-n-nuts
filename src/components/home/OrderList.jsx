    ...
    <div className='flex items-center gap-5'>
        ...
        <div className='flex items-center justify-between w-[80%]'>
            <div className='flex flex-col items-start gap-1'>
                <h1 className='text-[#f5f5f5] text-lg font-semibold tracking-wide'>Rashil Manandhar</h1>
            ...
            <div className='flex flex-col items-end gap-2'>
                ...
                <p className='text-[#ababab] text-sm'><FaCircle className='inline mr-2  text-green-600'/>
                Ready to serve</p>
            </div>
        </div>
    </div>
